...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "corporate retreat Patagonia",
    "team building Patagonia",
    "musical team building Argentina",
    "group activities Bariloche",
    "musical experiences",
    "rhythmic sign language",
    "Rhythmic Sign Language Bariloche",
    "group experiences Bariloche",
    "Argentina",
    "Santiago Vázquez",
    "Matías Pergolani",
    "drum circle Bariloche",
    "corporate experiences Patagonia",
  ],
